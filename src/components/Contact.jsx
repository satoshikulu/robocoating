  ...
  return (
    <section className="contact">
      <div className="container">
        ...
        <div className="section-header fade-in">
          ...
          <div className="contact-main-info">
            ...
            <div className="contact-info-item">
              ...
              <div className="contact-info-content">
                <div className="contact-info-label">MOBİL</div>
        ...
        <div className="factory-image-section fade-in">
          <div className="factory-image-wrapper">
            <img 
              src="https://www.robocoating.com.tr/images/WhatsApp-Image-2022-02-09-at-15.30.07-768x576.jpeg" 
              alt="Robocoating Fabrika - Endüstriyel Boyama Tesisi"
              className="factory-image"
            />
            <div className="factory-caption">
              <div className="factory-title">Robocoating</div>
            </div>
          </div>
        </div>
